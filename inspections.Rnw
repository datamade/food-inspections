...
First, we should briefly describe the analyses we have done.
...
restaurants are much the same for other types of high risk facilities.
...
manner, but there is some problems with how those inspections are
being recorded. If the many inspections are not being recorded, or
being recorded under the wrong license number, that may explain the
pattern we observe.
